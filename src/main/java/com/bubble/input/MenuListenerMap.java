...
public class MenuListenerMap {
    ...
    public MenuListenerMap() {
        ...
        listenerMap.put("start_button", new MouseInputListener().setOnClick(a -> System.out.println("clicked start")).setOnMove(a -> System.out.println("moooving to " + a.getLocation())));
    }
